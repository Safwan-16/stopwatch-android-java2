...
public class DefaultStopwatchStateMachine implements StopwatchStateMachine {
    ...
    @Override
    public void toAlarmState()      { setState(ALARMING); }
    ...
    @Override
    public void actionBeep()       { listener.playBeep(); }
    @Override
    public void actionStartAlarm() { listener.startAlarm(); }
    @Override
    public void actionStopAlarm()  { listener.stopAlarm(); }
